...
<nav class="navbar navbar-expand-lg navbar-light bg-warning">
  <div class="container">
    <a class="navbar-brand fs-1 fw-medium" href="#">Adding Job</a>
      ...
      <div class="card">
        <div class="card-body">
          ...
          <form action="success" method="post">
            ...
            <div class="mb-1">
              <label for="postVacance" class="form-label">Post Description</label>
              <textarea class="form-control" id="postVacance" name="postVacance" rows="2" required></textarea>
            </div>
